			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a style="color: green; text-decoration: none;" href="#" onclick="return false;"> Featured Articles </a></li>
					</ol>
				</nav>
			</div>
			<style type="text/css">
			...
			<div class="col-lg-12">
				<div class="panel panel-success">
					<div class="panel-heading bg-green">
						<h1 class="panel-title text-white"><b> FEATURED ARTICLES </b></h1>
					</div>
