			            ...
			            <div class="row" style="padding: 0rem 1rem;">
			            	<table class="table table-bordered table-condensed">
			            		<tr>
			            			...
			            			<!--<td class="col-sm-3 text-center"> <label> CLOSING DATE/TIME AT PHILGEPS WEBSITE </label> </td>-->
			            			<td class="col-sm-3 text-center p-2"> <label> TITLE </label> </td>
			            			<td class="col-sm-3 text-center p-2"> <label> RESULT </label> </td>
			            		</tr>	
