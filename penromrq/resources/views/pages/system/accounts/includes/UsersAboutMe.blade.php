<div class="box box-primary">
	<div class="box-body box-profile">
		<form method="post" action="{{ route('accounts.route',['path' => $path, 'action' => 'accounts-update-user-profile-photo','id' => encrypt($thisUserAccount->id) ]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
