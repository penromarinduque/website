...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#"><i class="fa fa-box"></i> Center Panel </a> </li>
		<li class="active"> <i class="fa fa-box"></i> Add Photo Releases </li>
	</ol>
</section>
	...
	<div class="box box-primary">
		...
		<div class="box-body">
            ...
            <div class="panel-body">
							@include('pages.admin.government.forms.formaddimageandvideos',['center' => $center, 'image' => true])
						</div>
					</div>
				</div>
			</div>
