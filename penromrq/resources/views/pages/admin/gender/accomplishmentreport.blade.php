                ...
                <div class="panel-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#list" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL REPORT </b></a></li>
                            <li><a href="#add" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD REPORT </b></a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane active fade in" id="list">
                            @include('pages.admin.gender.includes.tableaccomplishmentreport')
                        </div>
                        <div class="tab-pane fade" id="add">
                            @include('pages.admin.gender.forms.formaddaccomplishmentreport')
                        </div>
                    </div>
                </div>
            </div>
