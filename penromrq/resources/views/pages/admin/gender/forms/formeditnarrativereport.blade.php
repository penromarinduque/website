<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-update-narrative-report' , 'id' => encrypt($PanelLinks->link_id)]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
    <div class="row">
