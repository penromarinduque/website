<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-create-navigation-group' , 'id' => Crypt::encrypt('') ]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
	<div class="row">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td style="padding: 0px;">
								<input type="file" name="group_image" class="form-control input-sm" autocomplete="off" required>
							</td>
						</tr>
						<tr>
							<td style="font-weight: bold; font-size: 12px; vertical-align: middle; padding: 6px;">
