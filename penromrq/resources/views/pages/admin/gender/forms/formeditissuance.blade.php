<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-update-legal-issuance' , 'id' => Crypt::encrypt($PanelLinks->link_id)]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="number" autocomplete="off" value="{{ $PanelLinks->link_code }}" required>
                    </div>
                    <div class="form-group">
                        <label> ISSUANCE DESCRIPTION </label>
                        <textarea class="form-control" name="description" required style="resize: vertical;">{{ $PanelLinks->link_description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label> ISSUANCE LINK </label>
