<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-update-downloadable-form' , 'id' => Crypt::encrypt($PanelFiles->file_id)]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
    <div class="row">
