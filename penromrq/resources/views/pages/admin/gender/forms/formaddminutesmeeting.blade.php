<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-create-minutes-of-meeting' , 'id' => encrypt('3')]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="number" autocomplete="off" value="{{ date('Y-m-d') }}" required>
                    </div>
                    <div class="form-group">
