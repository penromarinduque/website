<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-create-special-order' , 'id' => Crypt::encrypt('3')]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
    <div class="row">
