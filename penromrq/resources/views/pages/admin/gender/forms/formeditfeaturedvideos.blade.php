<form method="post" action="{{ route('gender.route',['path' => $path, 'action' => 'gender-update-featured-videos' , 'id' => encrypt($PanelFiles->file_id)]) }}" enctype="multipart/form-data"> {{ csrf_field() }}
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="link" autocomplete="off" required value="{{ $PanelFiles->file_link }}">
                    </div>
