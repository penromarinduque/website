				...
				<div class="panel-body">
					<div class="nav-tabs-custom"> 
					    <ul class="nav nav-tabs">
					        <li class="active"><a href="#allcarousel" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL CAROUSEL </b></a></li>
					        <li><a href="#newcarouel" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD NEW CAROUSEL </b></a></li>
					    </ul>
					</div>
					<div class="tab-content">
						<div class="tab-pane active fade in" id="allcarousel"> 
						...
						<div class="tab-pane fade" id="newcarouel"> 
							@include('pages.admin.gender.forms.formaddcarouselgroupdetails')
						</div>
					</div>	
				</div>
			</div>
