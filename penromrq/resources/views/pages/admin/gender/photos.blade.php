            ...
            <div class="panel panel-default">
                <div class="panel-heading clearfix" style="background-color: white;">
                    <h3 class="panel-title pull-left">
                        <label><i class="fa fa-folder-o"></i> PHOTO SETUP </label>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="nav-tabs-custom"> 
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#allcontent" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL PHOTO </b></a></li>
                            <li><a href="#newcontent" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD PHOTO </b></a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane active fade in" id="allcontent">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach( $webdata->gender_retrieve_all_photos() as $key => $value)
                                    <tr>
                                        <td>
                                    ...
                                    @endforeach
                                    <tr>
                                      <td>{{ $webdata->gender_retrieve_all_photos()->links('pages.admin.gender.includes.genderpagination') }}</td>
                                    </tr>
                                </tbody>
                            </table> 
                        </div>
                        <div class="tab-pane fade" id="newcontent">
