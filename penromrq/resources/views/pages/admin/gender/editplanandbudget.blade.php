                ...
                <div class="panel-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li><a href="{{ route('gender.route',['path' => $path, 'action' => 'gender-retrieve-panel-details','id' => encrypt($GenderPanel->panel_id) ]) }}"><b> <i class="fa fa-list"></i> ALL PLAN </b></a></li>
                            <li><a href="#add" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD PLAN </b></a></li>
                            <li class="active"><a href="#edit" data-toggle="tab"><b> <i class="fa fa-edit"></i> EDIT PLAN </b></a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="edit">
                            @include('pages.admin.gender.forms.formeditplanandbudget')
                        </div>
                    </div>
                </div>
            </div>
