				...
				<div class="panel-body">
					<div class="nav-tabs-custom"> 
					    <ul class="nav nav-tabs">
					        <li class="active"><a href="#editgroup" data-toggle="tab"><b> <i class="fa fa-edit"></i> EDIT GROUP </b></a></li>
					        <li><a href="#allgroup" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL GROUP </b></a></li>
					    </ul>
					</div>
					<div class="tab-content">
						<div class="tab-pane active fade in" id="editgroup"> 
							@include('pages.admin.gender.forms.formeditcarouselgroup')
						</div>
						<div class="tab-pane fade" id="allgroup"> 
							<table class="table table-bordered table-hover">
								...
								<tbody>
									@foreach( app('GenderCarouselGroup')->orderBy('order_level','desc')->get() as $key => $value)
									<tr>
