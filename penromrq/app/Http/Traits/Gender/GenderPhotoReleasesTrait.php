...
trait GenderPhotoReleasesTrait	
{

	public function gender_photo_releases_rules()
	{
		return [
	...
	public function gender_create_photo_releases($method, $id = null, $request)
	{

		$rules = $this->gender_photo_releases_rules();
	...
	public function gender_edit_photo_releases($method, $id = null, $request)
	{
	...
	public function gender_update_photo_releases($method, $id = null, $request)
	{
	...
	public function gender_toggle_photo_releases_tab($method, $id = null, $request)
	{
	...
	public function gender_toggle_photo_releases($method, $id = null, $request) 
	{
		$panelDetails = app('GenderPanelDetails')->where('detail_id', Crypt::decrypt($id));
		if(count($panelDetails->first()) > 0) {
			$panelDetailsContent = $this->gender_panel_detail_content($panelDetails->first());
	...
	public function gender_delete_photo_releases($method, $id = null, $request)
	{
