...
trait GenderSpecialOrderTrait	
{

	public function gender_special_order_rules()
	{
		return [
	...
	public function gender_create_special_order($method, $id = null, $request)
	{

		$rules = $this->gender_special_order_rules();
		...
		Session::flash('success','New Special Order successfully created.');
		return back();
	
	}

	public function gender_edit_special_order($method, $id = null, $request)
	{
		...
		if(count($PanelDetails) > 0) {
		    ...
		    Session::flash('failed','Special Order data do not exists.');
		    return back();
		}
	
	}

	public function gender_update_special_order($method, $id = null, $request)
	{
		...
		if(count($panelLinks->first()) > 0) {
			...
			Session::flash('success','Special Order successfully updated.');
			return back();
	...
	public function gender_toggle_special_order_tab($method, $id = null, $request)
	{
	...
	public function gender_toggle_special_order($method, $id = null, $request) 
	{
	...
	public function gender_delete_special_order($method, $id = null, $request)
	{
		...
		Session::flash('success','Special Order successfully deleted.');
		return back();
