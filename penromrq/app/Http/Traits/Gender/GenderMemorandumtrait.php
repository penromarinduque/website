...
trait GenderMemorandumTrait	
{

	public function gender_memorandum_rules()
	{
		return [
	...
	public function gender_create_memorandum($method, $id = null, $request)
	{

		$rules = $this->gender_memorandum_rules();
		...
		Session::flash('success','New Memorandum successfully created.');
		return back();
	
	}

	public function gender_edit_memorandum($method, $id = null, $request)
	{
		...
		if(count($PanelDetails) > 0) {
		    ...
		    Session::flash('failed','Memorandum data do not exists.');
		    return back();
		}
	
	}

	public function gender_update_memorandum($method, $id = null, $request)
	{
		...
		if(count($panelLinks->first()) > 0) {
			...
			Session::flash('success','Memorandum successfully updated.');
			return back();
	...
	public function gender_toggle_memorandum_tab($method, $id = null, $request)
	{
	...
	public function gender_toggle_memorandum($method, $id = null, $request) 
	{
	...
	public function gender_delete_memorandum($method, $id = null, $request)
	{
		...
		Session::flash('success','Memorandum successfully deleted.');
		return back();
